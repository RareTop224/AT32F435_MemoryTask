...
#define GPIOD_CFGR (*(volatile uint32_t *)(GPIOD_BASE + 0x00))
...
#define GPIOD_ODT (*(volatile uint32_t *)(GPIOD_BASE + 0x14))
#define GPIOD_SCR (*(volatile uint32_t *)(GPIOD_BASE + 0x18))

int main(){
	RCC_AHB1ENR |= (1 << 3);	// enable clocking for pin D
	
	GPIOD_MODER &= ~(3 << (13 * 2));  
  GPIOD_MODER |=  (1 << (13 * 2));	// PD13 output 
